# Fantazy Platform Canon

> This document defines what Fantazy is, regardless of genre, theme, or studio.

---

## 1. What Fantazy Is (Platform Definition)

Fantazy is a **chat-based episodic experience platform**.
...
Fantazy is not defined by romance, fantasy, or any single genre.

> Fantazy is a system for turning moments into interactive stories.
...
## 2. The Fantazy Thesis (Genre-Agnostic)
...
Fantazy treats **episodes as first-class citizens**.
...
Regardless of genre, every Fantazy episode must pass:
...
## 5. Fantazy's Role vs. Studios

**Fantazy (Platform)** provides:
...
- freedom to explore multiple genres
- clarity in moderation and policy
- modular monetization strategies
- long-term creative scalability
- resilience against market shifts

Romance is powerful — but **it's not the only axis of value**.
...
Each studio follows Fantazy platform rules while defining its own creative bar.
...
- **elevating Fantazy above any single genre**
