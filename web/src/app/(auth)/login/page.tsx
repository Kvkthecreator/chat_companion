...
export default function LoginPage() {
  ...
  // Get the redirect destination from query params (e.g., /login?next=/series/villainess-survives)
            ...
            <CardContent className="p-8">
              ...
              {emailSent ? (
                <div className="space-y-3 text-center">
                  <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-muted text-lg">
                    ✉️
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Check your inbox to continue.</p>
                  </div>
                ...
                <>
                  ...
                  >
                    {isLoading ? (
                      <>
                        <div className="h-4 w-4 animate-spin rounded-full border-2 border-muted-foreground/60 border-t-primary" />
                        Signing in...
                      </>
                    ) : (
                      <>
