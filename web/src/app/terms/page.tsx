  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12 text-sm text-foreground">
      ...
      <p className="mt-4 text-muted-foreground">
        These terms outline how you may use Fantazy. By signing in and using the service, you agree to abide by
      ...
      <ul className="mt-6 list-disc space-y-2 pl-5 text-muted-foreground">
        <li>Use Fantazy for personal, non-commercial purposes unless otherwise approved.</li>
