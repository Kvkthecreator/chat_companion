...
export default function SeriesPageClient({ params }: PageProps) {
    ...
    async function loadData() {
      try {
        ...
        if (found) {
          ...
          // If authenticated, fetch user context and progress
          if (isAuthenticated) {
            try {
              const contextData = await api.series.getUserContext(found.id);
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-6xl px-6 py-8 space-y-8 pb-16">
        {/* Back navigation */}
        <Link
        ...
        <div className="relative overflow-hidden rounded-xl">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6">
            ...
            {selectedCharacter && isAuthenticated && (
        ...
        {hasUserCharacters && !selectedCharacter && isAuthenticated && (
        ...
        {/* Your Progress Section - Only if user has started and is authenticated */}
          ...
          <section className="space-y-4">
              ...
              <Card className="bg-primary/5 border-primary/20">
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">Episode 0 is free to try</p>
                    <p className="text-xs text-muted-foreground">Sign in to start your story and save your progress</p>
                  </div>
                </CardContent>
              </Card>
            )}
            ...
            <div className="space-y-3">
              {sortedEpisodes.map((episode) => {
                ...
                const hasStartedEpisode = !!episodeProgress; // Any interaction = started
                  ...
                  >
                    <div className="flex">
                      ...
                      <div className="relative w-32 sm:w-48 h-24 sm:h-32 shrink-0 overflow-hidden bg-muted">
                        ...
                        {/* Started indicator (clock icon) - only for authenticated users */}
                        {hasStartedEpisode && isAuthenticated && (
                      ...
                      <CardContent className="flex-1 p-4 flex flex-col justify-center">
                        <div className="flex items-center gap-2 mb-1">
                          <Badge
                            ...
                            className={cn(
                              ...
                              episode.episode_number === 0 && "bg-emerald-500 text-white"
                            )}
                          >
                            Episode {episode.episode_number}
                            {episode.episode_number === 0 && " — Free"}
                          </Badge>
                        ...
                        <Button
                          variant={isCurrent ? "default" : episode.episode_number === 0 ? "default" : "outline"}
                          size="sm"
        ...
        {/* Character Selection Modal (ADR-004) - only for authenticated users */}
