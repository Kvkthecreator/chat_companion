  ...
  return (
    <div className="my-4 w-full">
      <div className="relative overflow-hidden rounded-2xl shadow-lg">
        ...
        <div className="absolute bottom-0 left-0 right-0 flex items-start justify-between gap-2 px-4 py-3">
          <p className="flex-1 text-sm italic text-white/90 drop-shadow">
          ...
          {episodeImageId && (
            <button
              ...
              disabled={isSaving}
              className={cn(
                "flex-shrink-0 rounded-full p-2 backdrop-blur-sm transition-colors",
                isMemory
